  ...
  <div class="row">
    <div class="col-lg-3 col-6">
      ...
      <div class="small-box bg-info">
        <div class="inner">
          <h3 style="font-size: 30px">{{$orders_count}}</h3>
    ...
    <div class="col-lg-3 col-6">
      ...
      <div class="small-box bg-success">
        <div class="inner">
          <h3 style="font-size: 30px">{{config('settings.currency_symbol')}} {{number_format($income, 2)}}</h3>
    ...
    <div class="col-lg-3 col-6">
      ...
      <div class="small-box bg-danger">
        <div class="inner">
          <h3 style="font-size: 30px">{{config('settings.currency_symbol')}} {{number_format($income_today, 2)}}</h3>
    ...
    <div class="col-lg-3 col-6">
      ...
      <div class="small-box bg-warning">
        <div class="inner">
          <h3 style="font-size: 30px">{{$customers_count}}</h3>
