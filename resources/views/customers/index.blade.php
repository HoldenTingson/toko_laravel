        ...
        <table class="table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="vertical-align: middle">{{$customer->first_name}}</td>
                    <td style="vertical-align: middle">{{$customer->last_name}}</td>
                    ...
                    <td style="vertical-align: middle">{{
                        \Carbon\Carbon::parse($customer->created_at)->translatedFormat('l, j F Y H:i:s') }}</td>
                    <td style="vertical-align: middle">
